...
- `INDEXTTS_HOME=~/Library/index-tts`
- `HTML_VIDEO_HOME=~/Documents/Works/Agents/Handle/html-video`
...
```bash
export INDEXTTS_HOME=~/Library/index-tts
export HTML_VIDEO_HOME=~/Documents/Works/Agents/Handle/html-video
```

`make-video` should treat project folders under `~/Documents/Works/Agents/Video` as outputs/workspaces, not as long-lived model checkouts.
